...
public class UpsertIfTest
{
    ...
    public void Should_create()
    {
        ...
        var upsert = new UpsertIf<string>(new ValueExists(false), new ValueChanged(false));
    ...
    public void Should_update_changed()
    {
        ...
        var upsert = new UpsertIf<string>(new ValueExists(true), new ValueChanged(true));
    ...
    public void Should_update_not_changed()
    {
        ...
        var upsert = new UpsertIf<string>(new ValueExists(true), new ValueChanged(false));
        upsert.Sync("a", target, (createValue) => {}, (updateValue) => valueUpdated = updateValue);
